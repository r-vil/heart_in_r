...
# ‚?¢ il tipo di relazione tramite re la bont√† del modello tramite R!; 
...
# le nostre previsioni di max hr in base all'et‡ non sono precise al 100% ma rientrano nel range della predizione 
# perchË abbiamo generato dati casuali
